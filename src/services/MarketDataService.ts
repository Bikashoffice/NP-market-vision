...
export class MarketDataService {
  static async getTopMovers(): Promise<any> {
    ...
    // Current Nepal Stock Exchange data from screenshots - Updated June 5, 2025
    const stockData = [
      { symbol: 'RFPL', name: 'Rasuwa Fewa Power Limited', price: 524.60, change: 10.00, volume: 191583, open: 468, high: 524.6, low: 468, previousClose: 476.91 },
      { symbol: 'BPCL', name: 'Bottlers Nepal (Terai) Limited', price: 632.10, change: 9.98, volume: 809251, open: 586, high: 632.1, low: 576, previousClose: 574.72 },
      { symbol: 'PURE', name: 'Pure Energy Limited', price: 512.30, change: 9.98, volume: 400, open: 475.1, high: 512.29, low: 475.1, previousClose: 465.8 },
      { symbol: 'BARUN', name: 'Barun Hydropower Company Limited', price: 319.28, change: 9.96, volume: 437031, open: 296.1, high: 319.3, low: 296.1, previousClose: 290.36 },
      { symbol: 'SAPDBL', name: 'Saptakoshi Power Development Company Limited', price: 1088.85, change: 9.50, volume: 187206, open: 1010, high: 1091, low: 980, previousClose: 994.4 },
      { symbol: 'RADHI', name: 'Radhi Bidyut Company Limited', price: 838.00, change: 7.56, volume: 1119113, open: 790, high: 850, low: 785, previousClose: 786.45 },
      { symbol: 'UPCL', name: 'Universal Power Company Limited', price: 468.00, change: 6.44, volume: 1405405, open: 437, high: 471, low: 437, previousClose: 440.27 },
      { symbol: 'NGPL', name: 'Nepal Gas and Power Limited', price: 394.00, change: 4.01, volume: 1112259, open: 373, high: 399, low: 373, previousClose: 380.6 },
      { symbol: 'AKPL', name: 'Arun Kabeli Power Limited', price: 277.20, change: 1.18, volume: 1057285, open: 279.1, high: 279.1, low: 270, previousClose: 273.68 },
      ...
      { symbol: 'GRDBL', name: 'Gurkhas Development Bank Limited', price: 1252.71, change: -3.90, volume: 51430, open: 1281, high: 1355, low: 1248, previousClose: 1303.58 },
      { symbol: 'NMB50', name: 'NMB 50', price: 10.50, change: -3.67, volume: 1000, open: 10.69, high: 10.69, low: 10.48, previousClose: 10.9 },
      { symbol: 'SMH', name: 'Summit Medical Hall', price: 870.90, change: -3.55, volume: 101, open: 903, high: 919, low: 865.1, previousClose: 903 },
      { symbol: 'JSLBB', name: 'Janautthan Samudayik Laghubitta Bittiya Sanstha Limited', price: 1346.00, change: -3.47, volume: 319, open: 1368, high: 1368, low: 1345, previousClose: 1394.40 },
      ...
      { symbol: 'NABIL', name: 'NABIL Bank Limited', price: 492.37, change: 0.26, volume: 47113, open: 498, high: 498, low: 489, previousClose: 491.11 },
      { symbol: 'NICA', name: 'NIC Asia Bank Limited', price: 353.75, change: -0.06, volume: 84068, open: 351.1, high: 357, low: 350, previousClose: 353.97 },
      { symbol: 'EBL', name: 'Everest Bank Limited', price: 653.07, change: 0.99, volume: 75653, open: 654, high: 654, low: 645, previousClose: 646.67 }
    ];
    ...
    // Calculate market summary based on current data from screenshots
    const advances = 94; // From screenshot
    const declines = 153; // From screenshot
    const neutral = 1; // From screenshot

    return {
      nepseIndex: 2640.96, // Current NEPSE index from screenshot
      nepseChange: -0.22, // Daily change percentage from screenshot
      totalTurnover: '7,970,886,663.46', // From screenshot
      sharesTraded: '17,108,809', // From screenshot
      companiesTraded: 311,
      advances,
      declines,
      neutral,
      allStocks: stockData, // Add all stocks data for the new tab
